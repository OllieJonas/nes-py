...
_This is not my own work!! This is a fork of Kautenja's nes-py. The only modifications made are to upgrade it to the latest version of gym (0.26.2), which has breaking changes to it. The original README for the project is below._
